...
export default function AdminUserManagementPanel() {
  ...
  return (
    <div className="admin-panel user-control-room grid w-full min-w-0 max-w-full gap-3 sm:gap-4">
      <section className="admin-section min-w-0 rounded-xl border border-[color:var(--shell-border)] bg-[color:var(--shell-surface)] p-4">
