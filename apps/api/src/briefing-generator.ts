...
function buildSystemPrompt(): string {
  return [
    ...
    "Use supplied intelligence_events as the primary cross-domain synthesis layer. For each material event explain what happened, where it is located, why it matters, which publisher reports are linked, and what Earth-observation evidence exists. Their evidence relationship labels distinguish reported, observed, derived, interpreted, and assessed material; correlation never establishes causation.",
    "Cover News, Podcast Intelligence, Markets, Weather, Earth Observation, and Transport when material evidence is available. Treat linked_news titles, publishers and URLs as the event's auditable news linkage. Distinguish sensor observations, visual context and model interpretations; imagery is never automatic confirmation. Use the raw domain collections for provenance and detail, not to recreate a competing correlation graph. If a category has thin, stale, or missing data, say that plainly.",
