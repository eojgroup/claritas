...
exports.isPaywallEnabled = isPaywallEnabled;
exports.getBillingPublicUrls = getBillingPublicUrls;
exports.resolveBillingAccessState = resolveBillingAccessState;
...
function mapInactiveReason(status) {
    if (status === "active" || status === "trialing" || status === "grace_period") {
        return "subscription_expired";
    }
    return "subscription_inactive";
}
function mapActiveReason(status) {
    if (status === "trialing")
        return "trialing_subscription";
...
function isNotExpired(currentPeriodEnd) {
    if (!currentPeriodEnd)
        return true;
...
async function resolveBillingAccessState(input) {
