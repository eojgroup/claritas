...
-- ===================================
-- Weather snapshots (per-country, latest)
-- ===================================
-- Stores the latest weather observation per country from providers like OpenWeather.
-- We keep one row per (source_id, country_iso2) and update it in-place.
